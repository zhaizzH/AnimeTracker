...
测试文件也需核对导入和可执行性：2026-09-10 曾发现能力路由测试引用缺失符号；2026-09-12 的既有质量记录说明该测试已重写。此处保留历史教训，不将旧失败描述为当前状态；2026-09-16 本轮复核重新运行了 Business Java 测试和 Javadoc 检查，结果见 [后端质量门禁](../backend/quality-guidelines.md#当前测试基线)。
